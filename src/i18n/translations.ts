...
const en = {
  ...
  'common.communityActive': 'Active in the community',
  ...
  // Dashboard
  'dash.units': 'Trading units',
  'dash.newUnit': 'New unit',
  'dash.loadingUnits': 'Loading units from relays...',
  'dash.noUnits': 'You don\'t have any trading units yet',
  ...
  'dash.noListings': 'You don\'t have any listings yet',
  ...
  'buf.feeTitle': 'Default fee policy',
  'buf.feeDesc': 'When creating the unit, a fee policy (KIND 30902) will be automatically published:',
  'buf.fee': 'Fee:',
  'buf.feeSame': '(same for shop and buyer)',
  'buf.feeNote': 'This is the default fee. The fee policy cannot be changed from this form once published.',
  ...
  'buf.payoutDesc': 'Choose how you want to receive your LanaPays fee payout.',
  'buf.payoutFiat': 'FIAT (bank account)',
  'buf.payoutLana': 'LANA wallet',
  'buf.payoutFiatNote': 'Payout will be sent to the bank account defined above.',
  ...
  'buf.walletVerifyFailed': 'Wallet verification failed',
  'buf.walletRequired': 'The LANA wallet must be verified as registered before saving. Enter a valid address and click "Verify".',
  'buf.images': 'Images',
  'buf.imagesDesc': 'At least one image is required. You can add more.',
  ...
  'buf.fillRequired': 'Fill in all required fields',
  'buf.addImage': 'and add at least one image',
  'buf.publishFailed': 'Failed to publish to relays',
  'buf.saveFailed': 'Save failed',
  'buf.publishedWithFee': 'Published to {n} relay(s). Fee policy (5% / 5%) published to {f} relay(s).',
  'buf.publishedFeeWarn': 'Published to {n} relay(s). Warning: fee policy publication failed.',
  ...
  'eco.sustainable': 'sustainable',
  'eco.recycled': 'recycled',
  'eco.zero_waste': 'zero waste',
  'eco.locally_sourced': 'locally sourced',
  'eco.fair_trade': 'fair trade',
  'eco.reclaimed': 'reclaimed',
  'eco.FSC_certified': 'FSC certified',
  'eco.locally_made': 'locally made',
  'eco.handcrafted': 'handcrafted',
  'eco.upcycled': 'upcycled',
  'eco.low_carbon': 'low carbon',
  'eco.natural': 'natural',
  'eco.vegan': 'vegan',
  'eco.slow_fashion': 'slow fashion',
  'eco.eco_friendly': 'eco friendly',
  'eco.carbon_offset': 'carbon offset',
  'eco.sustainable_tourism': 'sustainable tourism',
  'eco.locally_owned': 'locally owned',
  'eco.organic_food': 'organic food',
  'eco.renewable_energy': 'renewable energy',
  'eco.grain_free': 'grain free',
  'eco.cruelty_free': 'cruelty free',
  'eco.plastic_free': 'plastic free',
  'eco.non_toxic': 'non toxic',
  'eco.handmade': 'handmade',
  'eco.seasonal': 'seasonal',
  'eco.heirloom': 'heirloom',
  'eco.farm_to_table': 'farm to table',
  'eco.seasonal_only': 'seasonal only',
  'eco.gluten_free': 'gluten free',
  'eco.dairy_free': 'dairy free',
  'eco.halal': 'halal',
  'eco.kosher': 'kosher',
  ...
  'farmer.communityDesc': 'This producer actively collaborates with local restaurants and community projects, which enables them a sustainability premium of up to 20%.',
  ...
  'guidelines.premiumText': 'By following these principles, producers and other providers can earn a sustainability premium of up to',
  'guidelines.premiumSuffix': 'on their produce or homemade products (in Euros or Lana).',
  ...
  'guidelines.howStep3': 'You automatically receive the starting premium rate of 5 % (and your customer -5 %).',
  ...
  'guidelines.howStep5': 'As sustainability grows, so do the benefits: the refund for your customers increases from 5 % to 20 %, and at the same time your price premium increases by the same amount.',
  'guidelines.premiumQTitle': 'What does a 20 % premium for Abundance mean?',
  ...
  'guidelines.cashQDesc': 'When making a sale, enter the amount and the receipt number. If there is no receipt, attach a photo as proof of sale/purchase.',
  ...
  'guidelines.limitsTitle': 'Are you limited in fund payouts?',
  ...
  'guidelines.communityDesc': 'To maintain the 20 % sustainability premium, producers actively participate in the community:',
  'guidelines.communityItem1': 'Collaboration with local restaurants and shops',
  'guidelines.communityItem2': 'As a "best practice example" you are a caretaker for new providers who enter at 5 % and you guide them on the path to 20 %',
  ...
  'form.images': 'Images',
  'form.addImages': 'Add images (max 10MB)',
  ...
  'form.errorTitle': 'Enter a listing title',
  'form.errorPrice': 'Enter a valid price',
  ...
  'lunit.visit': 'visit',
  'lunit.person': 'person',
  'lunit.portion': 'portion',
  'lunit.night': 'night',
  'lunit.trip': 'trip',
  'lunit.session': 'session',
  'lunit.day': 'day',
  'lunit.week': 'week',
  'lunit.package': 'package',
  'lunit.hour': 'hour',
  'lunit.project': 'project',
  'lunit.consultation': 'consultation',
  'lunit.pair': 'pair',
  'lunit.box': 'box',
  'lunit.bottle': 'bottle',
  'lunit.m2': 'm²',
  ...
  'delivery.box_scheme': 'Box',

  // Unit categories
  'cat.eco_farm': 'Eco farm',
  'cat.shop': 'Shop',
  'cat.cafe': 'Café and restaurant',
  'cat.beauty': 'Beauty and wellness',
  'cat.fashion': 'Fashion',
  'cat.furniture': 'Furniture',
  'cat.construction': 'Construction',
  'cat.event': 'Event and workshop',
...
const sl: typeof en = {
  ...
  'footer.tagline': 'Povezujemo trajnostne in ekološke lokalne pridelovalce in druge ponudnike s skupnostjo. Podprite najboljše in izbirajte lokalno.',
  ...
  'country.all': 'Vse države',
  'country.filter': 'Država',
  ...
  'eco.sustainable': 'trajnostno',
  'eco.recycled': 'reciklirano',
  'eco.zero_waste': 'brez odpadkov',
  'eco.locally_sourced': 'lokalno pridelano',
  'eco.fair_trade': 'poštena trgovina',
  'eco.reclaimed': 'reciklirano',
  'eco.FSC_certified': 'FSC certifikat',
  'eco.locally_made': 'lokalno narejeno',
  'eco.handcrafted': 'ročno narejeno',
  'eco.upcycled': 'predelano',
  'eco.low_carbon': 'nizki CO₂',
  'eco.natural': 'naravno',
  'eco.vegan': 'vegansko',
  'eco.slow_fashion': 'počasna moda',
  'eco.eco_friendly': 'okolju prijazno',
  'eco.carbon_offset': 'kompenzacija CO₂',
  'eco.sustainable_tourism': 'trajnostni turizem',
  'eco.locally_owned': 'lokalna last',
  'eco.organic_food': 'bio hrana',
  'eco.renewable_energy': 'obnovljiva energija',
  'eco.grain_free': 'brez žit',
  'eco.cruelty_free': 'brez testiranja',
  'eco.plastic_free': 'brez plastike',
  'eco.non_toxic': 'brez strupov',
  'eco.handmade': 'ročno delo',
  'eco.seasonal': 'sezonsko',
  'eco.heirloom': 'dediščinska sorta',
  'eco.farm_to_table': 's kmetije na mizo',
  'eco.seasonal_only': 'samo sezonsko',
  'eco.gluten_free': 'brez glutena',
  'eco.dairy_free': 'brez mlečnih izdelkov',
  'eco.halal': 'halal',
  'eco.kosher': 'košer',
  ...
  'guidelines.premiumText': 'Z upoštevanjem teh načel lahko pridelovalci in drugi ponudniki pridobite trajnostni pribitek do',
  'guidelines.premiumSuffix': 'na svoje pridelke oz. domače proizvode (v Evrih ali Lanah).',
  ...
  'guidelines.howTitle': 'Sem pridelovalec/-ka, kako pristopim?',
  ...
  'guidelines.howStep3': 'Samodejno prejmete začetno stopnjo pribitka 5 % (in vaš kupec -5 %).',
  ...
  'guidelines.premiumQDesc': 'Če jabolka prodajate po 3 € na kilogram, pri 20 % pribitku kupec ob plačilu z Evri prejme 0,60 € povračila (v Lanah), vi pa dodatnih 0,60 € (v Evrih ali Lanah – po izbiri).',
  ...
  'lunit.package': 'paket',
  'lunit.hour': 'ura',
  'lunit.project': 'projekt',
  'lunit.consultation': 'posvet',
  'lunit.pair': 'par',
  'lunit.box': 'škatla',
  'lunit.bottle': 'steklenica',
  'lunit.m2': 'm²',
  'lunit.m3': 'm³',
